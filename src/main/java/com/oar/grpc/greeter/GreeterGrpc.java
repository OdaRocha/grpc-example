...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.oar.grpc.greeter.HelloRequest,
      com.oar.grpc.greeter.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.oar.grpc.greeter.HelloRequest.class,
      responseType = com.oar.grpc.greeter.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.oar.grpc.greeter.HelloRequest,
      com.oar.grpc.greeter.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.oar.grpc.greeter.HelloRequest, com.oar.grpc.greeter.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.oar.grpc.greeter.HelloRequest, com.oar.grpc.greeter.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.greeter.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.oar.grpc.greeter.HelloReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.oar.grpc.greeter.HelloRequest,
      com.oar.grpc.greeter.HelloReply> getSayHelloAgainMethod;
  ...
  public static io.grpc.MethodDescriptor<com.oar.grpc.greeter.HelloRequest,
      com.oar.grpc.greeter.HelloReply> getSayHelloAgainMethod() {
    io.grpc.MethodDescriptor<com.oar.grpc.greeter.HelloRequest, com.oar.grpc.greeter.HelloReply> getSayHelloAgainMethod;
  ...
  public static abstract class GreeterImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.oar.grpc.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<com.oar.grpc.greeter.HelloReply> responseObserver) {
      asyncUnimplementedUnaryCall(getSayHelloMethod(), responseObserver);
    }

    /**
     */
    public void sayHelloAgain(com.oar.grpc.greeter.HelloRequest request,
        io.grpc.stub.StreamObserver<com.oar.grpc.greeter.HelloReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.oar.grpc.greeter.HelloRequest,
                com.oar.grpc.greeter.HelloReply>(
  ...
  public static final class GreeterBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreeterBlockingStub> {
    ...
    /**
     */
    public com.oar.grpc.greeter.HelloReply sayHello(com.oar.grpc.greeter.HelloRequest request) {
    ...
    /**
     */
    public com.oar.grpc.greeter.HelloReply sayHelloAgain(com.oar.grpc.greeter.HelloRequest request) {
      return blockingUnaryCall(
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractFutureStub<GreeterFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.oar.grpc.greeter.HelloReply> sayHello(
        com.oar.grpc.greeter.HelloRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.oar.grpc.greeter.HelloReply> sayHelloAgain(
        com.oar.grpc.greeter.HelloRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.oar.grpc.greeter.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.oar.grpc.greeter.HelloReply>) responseObserver);
          break;
        case METHODID_SAY_HELLO_AGAIN:
          serviceImpl.sayHelloAgain((com.oar.grpc.greeter.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.oar.grpc.greeter.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.oar.grpc.greeter.DataService.getDescriptor();
    }
